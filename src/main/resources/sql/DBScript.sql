 ...
 */
CREATE
DATABASE IF NOT EXISTS `db_amis_demo` CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;


SELECT *
FROM cfg_business_subject_324225698253233659;

-- DELETE FROM cfg_business_subject_324225698253233659;

SELECT *
FROM t_template_form_conf_324225698253233659;

-- DELETE FROM t_template_form_conf_324225698253233659;

SELECT *
FROM t_template_form_data_324225698253233659;

-- DELETE FROM t_template_form_data_324225698253233659;

SELECT *
FROM `t_template_grid_conf_324225698253233659`;

-- DELETE FROM `t_template_grid_conf_324225698253233659`;

SELECT *
FROM t_template_grid_data_324225698253233659;

-- DELETE FROM t_template_grid_data_324225698253233659;
 ...
 * 业务主题列表配置表
 */
DROP TABLE IF EXISTS `t_template_grid_conf_324225698253233659`;
...
(
    ...
    `project_id`       bigint(20) NOT NULL COMMENT '项目ID',
    `subject_id`       bigint(20) DEFAULT NULL COMMENT '业务主题ID',
    `form_table_id`    bigint(20) DEFAULT NULL COMMENT '数据主表ID',
    `grid_table_id`    bigint(20) DEFAULT NULL COMMENT '数据从表ID',
    `grid_table_name`  varchar(200) DEFAULT NULL COMMENT '数据从表名称',
    `field_key`        varchar(200) DEFAULT NULL COMMENT '字段标识',
    `field_alias`      varchar(200) DEFAULT NULL COMMENT '字段别名',
    `field_name`       varchar(200) DEFAULT NULL COMMENT '字段名称',
    `field_type`       varchar(20)  DEFAULT NULL COMMENT '字段类型',
